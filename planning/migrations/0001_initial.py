...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('planning_meal', (
            ...
            ('shopping_list', self.gf('django.db.models.fields.related.ForeignKey')(related_name='meals', blank=True, to=orm['list.ShoppingList'])),
    ...
    models = {
        ...
        'planning.meal': {
            ...
            'shopping_list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'meals'", 'blank': 'True', 'to': "orm['list.ShoppingList']"}),
