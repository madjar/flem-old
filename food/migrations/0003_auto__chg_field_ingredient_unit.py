...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ingredient.unit'
        db.alter_column('food_ingredient', 'unit', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Ingredient.unit'
        db.alter_column('food_ingredient', 'unit', self.gf('django.db.models.fields.CharField')(max_length=64))
